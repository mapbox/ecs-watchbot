...
test('[template]', () => {
  ...
  const fargateDefaults = cf.merge(
    template({
      service: 'example',
      serviceVersion: '1',
      command: 'echo hello world',
  ...
  const fargateSecureSpot = cf.merge(
    template({
      service: 'example',
      serviceVersion: '1',
      command: 'echo hello world',
  ...
  expect(fargateSecureSpot.Conditions).toMatchSnapshot(
    'fargateSecureSpotConditions'
  );
  expect(
    fargateSecureSpot.Resources.WatchbotService.Properties.NetworkConfiguration
  ).toMatchSnapshot('fargateSecureSpotNetworkConfiguration');
  ...
  const setsAllCPUNumber = cf.merge(
    template({
      service: 'example',
      serviceVersion: '1',
      command: 'echo hello world',
