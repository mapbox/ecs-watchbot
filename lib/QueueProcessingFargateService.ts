 ...
 */
export interface MapboxQueueProcessingFargateServiceProps extends QueueProcessingFargateServiceProps {
...
export class MapboxQueueProcessingFargateService extends QueueProcessingServiceBase {
    ...
    constructor(scope: Construct, id: string, props: MapboxQueueProcessingFargateServiceProps) {
        ...
        const desiredCount = FeatureFlags.of(this).isEnabled(cx_api.ECS_REMOVE_DEFAULT_DESIRED_COUNT) ? undefined : this.minCapacity;
