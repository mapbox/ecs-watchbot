...
const pkg = require(path.resolve('usr', '../package.json'));
const dashboard = require(path.resolve('usr', 'lib/dashboard.js'));
...
module.exports = (options = {}) => {
  ...
  options.reservation.cpu = options.reservation.cpu || cf.if(prefixed('CapacityIsNotEC2'), 256, 128);
  ...
  return {
    ...
    Resources: Resources,
    Metadata: {
      EcsWatchbotVersion: require('usr/package.json').version
    },
    Mappings: {
      EcrRegion: {
        'us-east-1': {
