 ...
 * The maximum value for this option is 43200 (12 hours).
...
module.exports = (options = {}) => {
  ...
  if (!options.maxJobDuration > 43200) throw new Error('options.maxJobDuration exceeds max value');
