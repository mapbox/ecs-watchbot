 ...
 * an alarm. The default is 200 periods, or 200% cpu utilization. This parameter
 ...
 * the duration that the service average CPU utilization must be over the cpu threshold
 * before triggering an alarm. You specify the number of 1-minute periods before an
 * alarm is triggered. The default is 20 periods, or 20 minutes. This parameter
 * can be provided as either a number or a reference, i.e. `{"Ref": "..."}`.
 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.sqsAlarmThreshold=40] - Watchbot creates a
 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.sqsAlarmPeriods=24] - Use this parameter to control
...
module.exports = (options = {}) => {
  ...
  Resources[prefixed('QueueSizeAlarm')] = {
    ...
    Properties: {
      ...
      EvaluationPeriods: options.sqsAlarmPeriods,
      Statistic: 'Average',
      Threshold: options.sqsAlarmThreshold,
      Period: '300',
      ComparisonOperator: 'GreaterThanThreshold',
      Namespace: 'AWS/SQS',
      MetricName: 'ApproximateNumberOfMessagesVisible',
