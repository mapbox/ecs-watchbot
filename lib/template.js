 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.messageAlarmThreshold || options.alarmThreshold=40] - Watchbot creates a
 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.messageAlarmPeriods || options.alarmPeriods=24] - Use this parameter to control
...
module.exports = (options = {}) => {
  ...
  Resources[prefixed('QueueSizeAlarm')] = {
    ...
    Properties: {
      ...
      EvaluationPeriods: options.messageAlarmPeriods || options.alarmPeriods,
      Statistic: 'Average',
      Threshold: options.messageAlarmThreshold || options.alarmThreshold,
      Period: '300',
      ComparisonOperator: 'GreaterThanThreshold',
      Namespace: 'AWS/SQS',
      MetricName: 'ApproximateNumberOfMessagesVisible',
