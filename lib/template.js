...
module.exports = function(options) {
  ...
  options.backoff = (function() {
    if (typeof options.backoff === 'boolean') return options.backoff;
    if (typeof options.backoff === 'string') return options.backoff === 'true';
    return true;
  })();
  ...
  var references = {
    ...
    workerPolicy: cf.ref(prefixed('WorkerPolicy'))
  };
  ...
  resources[prefixed('WatcherPolicy')] = {
    ...
    Properties: {
      Roles: [cf.ref(prefixed('ClusterRole'))],
  ...
  resources[prefixed('Service')] = {
    ...
    DependsOn: [prefixed('Worker'), prefixed('WatchbotWatcherPolicy')],
    Properties: {
