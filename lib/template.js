 ...
 * @param {Number|ref} [options.cpuAlarmThreshold] - Use this parameter to control
 ...
 * @param {Number|ref} [options.cpuAlarmPeriods] - Use this parameter to control
 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.messageAlarmThreshold=40 || options.alarmThreshold] - Watchbot creates a
 ...
 * either a number or a reference, i.e. `{"Ref": "..."}`.
 * @param {Number|ref} [options.messageAlarmPeriods=24 || options.alarmPeriods] - Use this parameter to control
