  ...
  widgets: [
    ...
    },
    {
      ...
      properties: {
        view: 'timeSeries',
        stacked: false,
        title: 'WatchbotQueue: Response Duration (msec)',
        metrics: [
          ['Mapbox/ecs-watchbot', '${Prefix}ResponseDuration-${AWS::StackName}', { stat: 'Maximum' }],
          ['...', { stat: 'p99' }],
          ['...'],
          ['...', { stat: 'p50' }]
        ],
    ...
    },
    {
      ...
      properties: {
        view: 'timeSeries',
        stacked: false,
        title: 'WatchbotService: Task Counts',
        metrics: [
          ['ECS/ContainerInsights', 'RunningTaskCount', 'ClusterName', '${Cluster}', 'ServiceName', '${WatchbotService}', { period: 60 }],
          ['.', 'DesiredTaskCount', '.', '.', '.', '.', { period: 60 }],
          ['.', 'PendingTaskCount', '.', '.', '.', '.', { period: 60 }]
        ],
        region: '${AWS::Region}',
        period: 60
      }
    },
    {
      ...
      properties: {
        ...
        metrics: [
          ['ECS/ContainerInsights', 'RunningTaskCount', 'ClusterName', '${Cluster}', 'ServiceName', '${WatchbotService}', { period: 60 , yAxis: 'right'  }],
          ['.', 'DesiredTaskCount', '.', '.', '.', '.', { period: 60, yAxis: 'right'  }],
