  ...
  widgets: [
    {
      ...
      properties: {
        ...
        metrics: [
          ['AWS/SQS', 'ApproximateMessagesNotVisible', 'QueueName', '${AWS::StackName}-WatchbotQueue', { period: 60 }],
          ['AWS/SQS', 'ApproximateMessagesVisible', 'QueueName', '${AWS::StackName}-WatchbotQueue', { period: 60 }]
        ],
        region: '${AWS::Region}',
        period: 60,
        yAxis: {
    ...
    },
    {
      ...
      properties: {
        ...
        metrics: [
          ['AWS/ECS', 'CPUUtilization', 'ServiceName', '${WatchbotService}', { period: 60 }],
